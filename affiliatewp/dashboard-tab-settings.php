...
<div id="affwp-affiliate-dashboard-profile" class="affwp-tab-content">
	...
	<h3 class="aff-title"><?php _e( 'Profile Settings', 'affiliate-wp' ); ?></h3>

	<form id="affwp-affiliate-dashboard-profile-form" class="affwp-form" method="post">

		<div class="affwp-wrap affwp-payment-email-wrap form-row-first">
		...
		<div class="affwp-save-profile-wrap">
			...
			<input type="submit" class="button small" value="<?php esc_attr_e( 'Save Profile Settings', 'affiliate-wp' ); ?>" />
		</div>
