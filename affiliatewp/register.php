...
<div class="row">
	<div class="col-md-5 col-md-offset-4">
		...
		<header class="woo-entry-header">
			<h1 class="entry-title"><?php _e( 'Register a New Affiliate Account', 'affiliate-wp' ); ?></h1>	
		</header>
		...
		<form id="affwp-register-form" class="affwp-form" action="" method="post">
			...
			<fieldset>
				...
				<p>
					...
					<input class="button small" type="submit" value="<?php esc_attr_e( 'Register', 'affiliate-wp' ); ?>" />
				</p>
